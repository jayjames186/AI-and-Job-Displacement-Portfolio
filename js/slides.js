...
window.effectOffset = 100;
window.effectSpeed = 100;
window.slideSpeed = 100;
window.cleanupDelay = 100;
...
$(document).ready(function() { "use strict";
  ...
  if ($body.hasClass('fast')){
    //fast
    window.slideSpeed = 350;
    window.cleanupDelay = 1200;
    window.effectSpeed = 200;
